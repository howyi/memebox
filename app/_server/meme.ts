...
export type InsertMeme = Omit<typeof memes.$inferInsert, 'id'>

type CreatedMeme = {
    permalink: string
} & typeof memes.$inferInsert

export const NewMeme = async (meme: Omit<typeof memes.$inferInsert, 'id' | 'created_at'>): Promise<CreatedMeme> => {
